...
const Updateprofile = ({ navigation }) => {
    ...
    const [data, setData] = useState({
        avatar: { uri: 'https://yt3.googleusercontent.com/-CFTJHU7fEWb7BYEb6Jh9gm1EpetvVGQqtof0Rbh-VQRIznYYKJxCaqv_9HeBcmJmIsp2vOO9JU=s900-c-k-c0x00ffffff-no-rj' },
        nameShop: '',
        emailShop: '',
        address: '',
        phoneNumberShop: '',
    ...
    const postApi = async () => {
        if (!data.nameShop || !data.emailShop || !data.address || !data.phoneNumberShop || !data.des) {
            ToastAndroid.show(
