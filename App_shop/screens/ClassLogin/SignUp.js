...
const SignUp = () => {
    ...
    return (
        <SafeAreaView style={styles.continer}>
            <View>
                <Text style={{ fontSize: 48, fontWeight: 'bold', marginTop: 60, textAlign: 'center' }}> Create your Account </Text>
            </View>
            <View style={styles.formlogin}>
                ...
                <View style={styles.nhappass}>
                    ...
                    >
                        {getpassworsvisible1 ? <Entypo name='eye' size={35} color={'#000000'} />
                            :
                            <Feather name='eye-off' size={30} color={'#000000'} />
                        }
                    </TouchableOpacity>
                ...
                <View style={{ height: 130 }}>
                    <TouchableOpacity style={{ backgroundColor: '#000000', height: 65, width: 355, alignSelf: 'center', justifyContent: 'center', borderRadius: 30, marginTop: 10 }}

                        onPress={checkLogin} >
                        <Text style={{ textAlign: 'center', color: '#ffffff', fontSize: 25, }}>Sign Up  </Text>
                    </TouchableOpacity>
                ...
                <View style={{ width: '100%', height: 68, flexDirection: 'row', justifyContent: 'center' }}>
                    <Text style={{ fontSize: 18, color: '#7B7070', alignSelf: 'center' }} >Do you have an account ? </Text>
